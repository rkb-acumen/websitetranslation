    ...
    <>
      <div className="dataSoultions_grid_container">
        <div className="dataSoultions_grid_item">
          <div className="md:flex md:justify-between">
            <div className="md:w-[50%]">
              ...
              <p className="datasolutiions-description intropara font-14">
                {" "}
                {banner_description}{" "}
              </p>
            </div>
            ...
            {banner_video_section?.[0]?.banner_video_link && (
              <div className="relative mb-7 md:mb-0 cursor-pointer max-w-[100%] md:max-w-[100%]">
                <Image
                  src={`https://img.youtube.com/vi/${getYouTubeVideoId(banner_video_section?.[0]?.banner_video_link)}/maxresdefault.jpg`}
                  alt={"youtupevideo"}
                  height={800}
                  width={800}
                  className="rounded-[20px]  w-full mx-auto object-cover cursor-pointer"
                ...
                />
                  ...
                  >
                    <Image
                      ...
                      width={60}
                      height={60}
                      className="w-[40px] h-[40px] cursor-pointer opacity-100"
                    />
                  </div>
        ...
        <div className="dataSoultions_grid_item">
          ...
          <p className="intropara font-14"> {banner_data_counter_3_content}</p>
        </div>
        <div className="dataSoultions_grid_item">
