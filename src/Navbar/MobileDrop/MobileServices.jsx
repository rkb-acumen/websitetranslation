    ...
    try {
        ...
        return (
            <>
                ...
                {products.header_menu[0].main_menu[1].sub_menu.map((val)=>{return(<>
                    <li> <Link className='capitalize text-gray-800 transition-colors duration-300 hover:text-orange-600' href={val.sub_menu_link}>{val.sub_menu_name}</Link> </li>
                </>)})}
                </ul>
            </>
        );
